...
function createUserCard(user) {
  ...
  <ul>
    <li>
      <i class='bx bxs-user'>${user.followers}
      <strong>Followers</strong></i>
    </li>
    <li>
      <i class='bx bxs-user-detail' >${user.following}
      <strong>Following</strong></i>
    </li>
    <li>
      <i class='bx bxs-sticker'> ${user.public_repos}
      <strong>Repository</strong></i>
    </li>
  </ul>
